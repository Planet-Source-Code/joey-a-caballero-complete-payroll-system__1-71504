...
Begin VB.Form frm_Edit_emp 
   ...
   Begin VB.ComboBox cboEmpStat 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frm_Edit_emp.frx":4121
      Left            =   5160
      List            =   "frm_Edit_emp.frx":412B
      TabIndex        =   8
      Top             =   3120
      Width           =   1935
   End
   ...
   Begin VB.ComboBox cboStat 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frm_Edit_emp.frx":4145
      Left            =   1680
      List            =   "frm_Edit_emp.frx":4155
      TabIndex        =   2
      Top             =   2760
      Width           =   1935
   End
   Begin VB.ComboBox cboGender 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "frm_Edit_emp.frx":417C
      Left            =   1680
      List            =   "frm_Edit_emp.frx":4186
      TabIndex        =   1
      Top             =   2400
      Width           =   1935
   End
...
On Error GoTo err:
    ...
    rs.Open "Select * from tblEmp where EM_ID = " & Me.txtIDNo.Text, cn, adOpenKeyset, adLockPessimistic
    ...
    cmdCancel.Enabled = False
    cmdBrowse.Enabled = False
    MsgBox "Data entry successfully updated.", vbInformation
    UpdateInfo
    Exit Sub
err:
