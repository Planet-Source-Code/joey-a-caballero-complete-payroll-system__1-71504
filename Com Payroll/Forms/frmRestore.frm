...
ReleaseAndExit:
    ...
    Exit Sub
errh:
    'WriteErrorLog Me.Name, "cmdDelete_Click", err.Description
...
Private Sub cmdStart_Click()
    ...
    If MsgBox("Do you want to overwrite the current Database file wth this newly restored file?", vbQuestion + vbOKCancel) = vbOK Then
        ...
        If FSO.FileExists(Mod_Con.DBPathFileName) = True Then
...
ReleaseAndExit:
    ...
    Exit Sub
errh:
    'WriteErrorLog Me.Name, "cmdStart_Click", err.Description
    Resume ReleaseAndExit
End Sub
